...
public class SpringFoxConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("pl.edu.pjatk.jaz.jazs23575nbp.controllers"))
                .paths(PathSelectors.ant("/nbpmaterials/**"))
                .build()
                .apiInfo(apiInfo())
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "NBP average values",
                "Average value of gold provided by Narodowy Bank Polski",
                "Terms of service",
                "Terms of service",
                new Contact("Maciej Zagórski", "https://github.com/s23575/pjatk-jaz/tree/main/jaz-s23575-nbp",
